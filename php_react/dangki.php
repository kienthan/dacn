...
if (
    ...
    if ( 0 == 0 ) {
            $insertKH = mysqli_query($db_conn,"INSERT INTO `khachhang`(`sdt`, `email`, `matkhau`, `hoten`, `ngaysinh`, `gioitinh`, `diachi`) 
                                            VALUES ('$sdt','$email','$matkhau','$hoten','$ngaysinh','$gioitinh','$diachi')");
        if ($insertKH) {
