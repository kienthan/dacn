...
export class Products extends Component {
    ...
    xulynhap = (e) => {
        ...
        e.preventDefault();
        const obj = {
            plcu: this.props.match.params.phanloai,
            plmoi: this.state.plmoi,
        }
        console.log(obj)
        fetch("http://localhost/php_react/updatephanloai.php",{
                method:"POST",
        ...
        return (
          ...
          <div className="container-fluid">
              ...
              <form onSubmit={this.xulyluutru} className="col-lg-12 col-md-12 col-sm-12 mt-3">
                <div className="mb-3">
                    <label  className="form-label">Phân loại Cũ</label>
                    <input type="text" className="form-control" onChange={this.xulynhap} 
                    name="plcu" value={this.props.match.params.phanloai} readOnly/>
                </div>
                <div className="mb-3">
