              ...
              <div className="container-fluid" style={{minHeight:'1050px',background:'linear-gradient(-45deg, #ee7752, #e73c7e, #23a6d5, #23d5ab)'}}>
                  ...
                  <form onSubmit={this.xulyluutru} className="col-lg-12 col-md-12 col-sm-12">
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" onChange={this.xulynhap} value={this.props.match.params.mamh} 
                        name="mamh" readOnly />
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        name="tenmh"  defaultValue={products[0].tenmh} />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" className="form-control" defaultValue={products[0].url} 
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" className="form-control" value={products[0].mota}  
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" className="form-control" min="1" max="100" step="1"  defaultValue={products[0].soluongton}
                    ...
                    <div class="mb-3">
                        ...
                        onChange={this.xulynhap}  name="img" defaultValue={products[0].img}  />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        onChange={this.xulynhap}  name="tinhtrang" defaultValue={products[0].tinhtrang} />
                    </div>
