...
export default class CAPNHATKH extends Component{
    ...
    xulyluutru = (e) =>{
        ...
        const obj = {
            dienthoai : this.props.match.params.sdt,
        ...
        fetch("http://localhost/php_react/capnhatkhachhang.php",{
                method:"POST",
        ...
        return(
            ...
            <div className="container mr-3"> 
                <form onSubmit={this.xulyluutru} className="col-lg-12 col-md-12 col-sm-12">
                    <div className="">
                        <h4 className='text-center'>Cập nhật thông tin khách hàng</h4>
                        <div className="mb-3 ml-5 row ">
                        <input type="text" placeholder="Nhập Số Điện Thoại" name='sdt'  
                        className="form-control "  onChange={this.xulynhap} value={this.props.match.params.sdt} readOnly />
                        </div>
                        <div className="mb-3 ml-5 row">
                    ...
                    <div className="mb-3 ml-5 row " >
                        ...
                        <button type="submit" className="btn btn-success" style={{marginLeft:'40%'}}>Cập nhật</button>
                    </div>
                </form>
            </div>
            </div>
