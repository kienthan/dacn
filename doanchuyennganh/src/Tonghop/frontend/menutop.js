...
class Menutop extends Component {
  ...
  render() {
    const { cart, Dangxuat, getToken } = this.context;
    const getUser = JSON.parse(getToken());
    const dangnhap = () => {
      if (getUser === null)
        return (
          <div className="dropdown-menu " aria-labelledby="navbarDropdown">
            <Link className="dropdown-item" to="/login" disabled={true}>
              Đăng Nhập{" "}
            </Link>
          </div>
        );
            ...
            <ul className="navbar-nav">
              ...
              <li className="nav-item dropdown active">
                ...
                >
                  ...
                  <div className="dropdown-divider"></div>
                  <Link className="dropdown-item" to="/8">
                    Áo Blazer
                  </Link>
                </div>
              </li>
          ...
          <form className="form-inline">
            <div className="input-group input-group-md">
              ...
              <div className="input-group-append">
                <NavLink
                  activeClassName="input-group-append"
                  to={"/timkiem/" + this.state.timkiem}
                >
                  <button
