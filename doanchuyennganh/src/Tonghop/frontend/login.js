        ...
        return(
           ...
           <div className="row " id="__content"> 
            ...
            <div className="col-lg-6 col-md-6 text-center" id="content__left">
                ...
                <div id="btn__more">
                <button type="button" className="btn btn-warning"><i className="fab fa-instagram mr-2"></i>
                    Xem thêm tại Instagram</button>
                </div>
                <div id="btn__more">
                <button type="button" className="btn btn-warning"><i className="fab fa-youtube mr-3"></i>
